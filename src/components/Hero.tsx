  ...
  return (
    <section ref={sectionRef} className="relative w-full h-[150vh] md:h-[200vh]">
      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden bg-[#050505] text-[#050505]">
        ...
        <div 
          className="absolute inset-0 z-[2] cursor-pointer-custom mix-blend-difference" 
        ...
        {/* Step 1: Vertically centered and text increased in size */}
        <div ref={step1Ref} className="hero-step absolute top-0 right-0 w-[100%] md:w-[50vw] lg:w-[45vw] h-[30vh] bg-[#f4f4f5] z-[10] flex items-center justify-start p-8 md:p-12">
        ...
        {/* Step 2: Columns removed, text scaled to 80% height, Hey! positioned & rotated */}
        <div ref={step2Ref} className="hero-step absolute top-[30vh] right-0 w-[100%] md:w-[70vw] lg:w-[65vw] h-[40vh] bg-[#f4f4f5] z-[10] p-8 md:p-12 flex flex-col justify-center">
            
            <div className="relative ml-0 md:ml-16 lg:ml-24 w-fit">
              
              {/* Design & Code Headings sized using vh to perfectly cover ~80% of the 40vh step */}
              <h1 className="font-display text-[14vh] md:text-[16vh] leading-[0.8] tracking-tighter font-medium text-[#1a1a1a]">
              ...
              {/* Hey! I'm Prithwis + Arrow */}
              <div className="absolute -top-12 md:-top-10 -right-32 md:-right-48 lg:-right-66 z-20">
                <div className="reveal-text-wrapper overflow-visible">
                  {/* Forced 20deg rotation applied here */}
                  <div className="reveal-text flex flex-col items-center">
                    <span className="font-brisa text-[#5B50FF] text-4xl md:text-5xl tracking-wide whitespace-nowrap">Hey! I'm Prithwis</span>
                    {/* SVG arrow inverted (rotate-180 and flip) and colored #5B50FF */}
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31 32" fill="none" className="w-8 h-8 text-[#5B50FF] ml-10 rotate-[-90deg] scale-y-180">
        ...
        {/* Step 3: Bottom Right */}
        <div ref={step3Ref} className="hero-step absolute bottom-0 right-0 w-[100%] md:w-[90vw] lg:w-[85vw] h-[30vh] bg-[#f4f4f5] z-[10] p-8 md:p-12 flex items-end">
            <h2 className="font-display text-[15vw] md:text-[13vw] lg:text-[12.5vw] leading-[0.75] uppercase w-full font-bold text-[#1a1a1a]">
