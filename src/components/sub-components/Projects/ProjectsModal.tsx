    ...
    >
      ...
      <div className="w-full min-h-screen relative px-6 md:px-12 pb-32">
        ...
        <div className="py-24 border-t border-white/20 flex flex-col items-center justify-center text-center relative z-10">
          ...
          <button
            onClick={onClose}
            className="modal-text-reveal font-sans text-sm tracking-widest uppercase border-b border-white pb-1 hover:text-white/50 transition-colors hover:cursor-pointer-custom"
          >
            Return to Index
          </button>
        </div>
